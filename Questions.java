...
public class Questions {
	...
	public String sandwichFilling(String sandwich) {
		...
		index =sandwich.indexOf("bread");
		index2 = sandwich.indexOf("bread", sandwich.indexOf("bread") + 1 );
		if (sandwich.contains("bread")&& index2>0){
				for (int i = index2-1; i >=index+5 ; i--){
				output = output + sandwich.charAt(i);
			}
		}else { 
			return "";
		}
	...
	public boolean evenlySpaced(int a, int b, int c) {
		...
		int difference1 = numbers.get(1)-numbers.get(0);
		int difference2 = numbers.get(2)-numbers.get(1);
